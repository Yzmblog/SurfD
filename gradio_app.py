...
_TITLE = '''Surf-D: High-Quality Surface Generation for Arbitrary Topologies using Diffusion Models'''
_DESCRIPTION = '''
<div>
...
<a href='https://yzmblog.github.io/projects/SurfD/'>Project Page</a>, <a href='https://github.com/Yzmblog/SurfD'>Code</a>, <a href='https://arxiv.org/abs/2311.17050'>Paper</a> <br>
</div>
<div>
This demo currently supports the following tasks: Sketch to Shape, Text to Shape.
</div>
'''
_GPU_ID = 0
...
def prepare_data(single_image, crop_size):
    dataset = SingleImageDataset(root_dir='', num_views=6, img_wh=[256, 256], bg_color='white', crop_size=crop_size,
...
with gr.Blocks(title=_TITLE, theme=custom_theme, css=custom_css) as demo:
    ...
    with gr.Row(variant='panel'):
        ...
        with gr.Column(scale=1):
            ...
            gr.Markdown(
                "<span style='color:red'> Reconstruction may cost several minutes. Check results in instant-nsr-pl/exp/scene@{current-time}/ </span>")
    ...
    run_btn.click(
        fn=partial(preprocess, SimpleModel), inputs=[input_image, input_processing],
        ...
        outputs=[view_1, view_2, view_3, view_4, view_5, view_6, normal_1, normal_2, normal_3, normal_4, normal_5,
                 normal_6],
    ).success(
